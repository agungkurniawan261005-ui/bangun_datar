...
if menu == 'Luas Persegi':
    ...
    st.image('rumus-persegi.jpg.webp', caption="Rumus Luas Persegi", width=300  )
    ...
    st.image('kumpulan-rumus-segitiga-dalam-matematika-mudah.jpg', caption="Rumus Luas Segitiga", width=300)
    ...
    st.image('Rumus-Luas-Dan-Keliling-Lingkaran.png.webp', caption="Rumus Luas Lingkaran", width=300)
